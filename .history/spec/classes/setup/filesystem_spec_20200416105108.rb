...
describe 'cis_hardening::setup::filesystem' do
  on_supported_os.each do |os, os_facts|
    context "on #{os}" do
      ...
      it { is_expected.to contain_file_line('udf_disable').with(
        'ensure' => 'present',
        'path'   => '/etc/modprobe.d/CIS.conf',
      ...
      it { is_expected.to contain_file_line('vfat_disable').with(
        'ensure' => 'present',
        'path'   => '/etc/modprobe.d/CIS.conf',
      ...
      # Section 1.1.2
      it { is_expected.to contain_exec('checktmp_part').with(
      ...
      # Section 1.1.3
      it { is_expected.to contain_exec('chktmp_nodev').with(
        'path'    => '/bin:/sbin:/usr/bin:/usr/sbin:/usr/local/bin:/usr/local/sbin',
      ...
      # Section 1.1.4
      it { is_expected.to contain_exec('chktmp_nosuid').with(
        'path'    => '/bin:/sbin:/usr/bin:/usr/sbin:/usr/local/bin:/usr/local/sbin',
      ...
      # Section 1.1.5
      it { is_expected.to contain_exec('chktmp_noexec').with(
        'path'    => '/bin:/sbin:/usr/bin:/usr/sbin:/usr/local/bin:/usr/local/sbin',
      ...
      it { is_expected.to contain_exec('chkvar_part').with(
        'path'    => '/bin:/sbin:/usr/bin:/usr/sbin:/usr/local/bin:/usr/local/sbin',
      ...
      it { is_expected.to contain_exec('chkvartmp_part').with(
        'path'    => '/bin:/sbin:/usr/bin:/usr/sbin:/usr/local/bin:/usr/local/sbin',
      ...
      it { is_expected.to contain_exec('chkvartmp_nodev').with(
        'path'    => '/bin:/sbin:/usr/bin:/usr/sbin:/usr/local/bin:/usr/local/sbin',
      ...
      it { is_expected.to contain_exec('chkvartmp_nosuid').with(
        'path'    => '/bin:/sbin:/usr/bin:/usr/sbin:/usr/local/bin:/usr/local/sbin',
      ...
      it { is_expected.to contain_exec('chkvartmp_noexec').with(
        'path'    => '/bin:/sbin:/usr/bin:/usr/sbin:/usr/local/bin:/usr/local/sbin',
      ...
      it { is_expected.to contain_exec('chkvarlog_part').with(
        'path'    => '/bin:/sbin:/usr/bin:/usr/sbin:/usr/local/bin:/usr/local/sbin',
      ...
      it { is_expected.to contain_exec('chkvarlogtmp_part').with(
        'path'    => '/bin:/sbin:/usr/bin:/usr/sbin:/usr/local/bin:/usr/local/sbin',
